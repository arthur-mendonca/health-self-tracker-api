...
import type { DailyRecord, DropTime } from "../../../domain/entities/DailyRecord.ts";

export type UpsertDailyRecordCommand = {
  date?: string;
...
export interface UpsertDailyRecordUseCase {
  execute(command: UpsertDailyRecordCommand): Promise<DailyRecord>;
}
